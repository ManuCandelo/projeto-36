class Question {
  ...
  display(){
    ...
    this.question.html("Charada:- O que é que dá o poder de atravessar paredes? " );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("1: Um martelo" );
    this.option1.position(150, 100);
    this.option2.html("2: Uma porta" );
    this.option2.position(150, 120);
    this.option3.html("3: Uma janela" );
    this.option3.position(150, 140);
    this.option4.html("4: Uma pá" );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Obrigada, Sua Resposta Foi Enviada");
